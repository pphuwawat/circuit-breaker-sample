...
public class CoffeeRepositoryService {
    ...
    @CircuitBreaker(requestVolumeThreshold = 8,failureRatio =0.25,delay = 5000L,successThreshold = 2)
    ...
    private void maybeFail() {
        ...
        if (invocationNumber % 4 > 2) { // alternate 2 successful and 1 failing invocations
